...
public class Fp04 {
    public static void main(String[] args) {
        ...
        System.out.println("faktoryelHesapla(5) = " + faktoryelHesapla(5));
        System.out.println("verilenIkiSayiarasindakiCiftSayilarinToplami(11, 5) = " + verilenIkiSayiArasindakiCiftSayilarinToplami(11, 5));
