...
public class Fp05 {
    public static void main(String[] args) {
        ...
        System.out.println("ortalamaPuanlarVerilenSayidanBuyukMu(coursesList) = " + ortalamaPuanlarVerilenSayidanBuyukMu(coursesList, 93));
        System.out.println("herhangiBirKursAdiKelimeyiIceriyorMu(\"Turkish\") = " + herhangiBirKursAdiKelimeyiIceriyorMu(coursesList, "X"));
        ortalamasıiEnYuksekKursunAdiniYazdir(coursesList);
        System.out.println();
        System.out.println("ortalamaPuanaGoreSiralaVeIlkVerilenleriAtla(coursesList,2) = " + ortalamaPuanaGoreSiralaVeIlkVerilenleriAtla(coursesList, 2));
    ...
    public static void ortalamasıiEnYuksekKursunAdiniYazdir(List<Courses> list){
